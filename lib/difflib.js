...
(function() {
  var Differ, Heap, IS_CHARACTER_JUNK, IS_LINE_JUNK, SequenceMatcher, assert, contextDiff, floor, getCloseMatches, max, min, ndiff, restore, unifiedDiff, _arrayCmp, _calculateRatio, _countLeading, _formatRangeContext, _formatRangeUnified, _has,
  ...
  unifiedDiff = function(a, b, _arg) {
    var file1Range, file2Range, first, fromdate, fromfile, fromfiledate, group, i1, i2, j1, j2, last, line, lines, lineterm, n, started, tag, todate, tofile, tofiledate, _i, _j, _k, _l, _len, _len2, _len3, _len4, _len5, _m, _ref, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
    ...
    */
    ...
    lines = [];
    started = false;
    _ref2 = (new SequenceMatcher(null, a, b)).getGroupedOpcodes();
    for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
      ...
      _ref3 = [group[0], group[group.length - 1]], first = _ref3[0], last = _ref3[1];
      file1Range = _formatRangeUnified(first[1], last[2]);
      file2Range = _formatRangeUnified(first[3], last[4]);
      lines.push("@@ -" + file1Range + " +" + file2Range + " @@" + lineterm);
      for (_j = 0, _len2 = group.length; _j < _len2; _j++) {
        _ref4 = group[_j], tag = _ref4[0], i1 = _ref4[1], i2 = _ref4[2], j1 = _ref4[3], j2 = _ref4[4];
        if (tag === 'equal') {
          _ref5 = a.slice(i1, i2);
  ...
  contextDiff = function(a, b, _arg) {
    var file1Range, file2Range, first, fromdate, fromfile, fromfiledate, group, i1, i2, j1, j2, last, line, lines, lineterm, n, prefix, started, tag, todate, tofile, tofiledate, _, _i, _j, _k, _l, _len, _len2, _len3, _len4, _len5, _m, _ref, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
    _ref = _arg != null ? _arg : {}, fromfile = _ref.fromfile, tofile = _ref.tofile, fromfiledate = _ref.fromfiledate, tofiledate = _ref.tofiledate, n = _ref.n, lineterm = _ref.lineterm;
    /*
    ...
    for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
      ...
      if (!started) {
        ...
        if (((function() {
          ...
          _results = [];
          for (_j = 0, _len2 = group.length; _j < _len2; _j++) {
            _ref4 = group[_j], tag = _ref4[0], _ = _ref4[1], _ = _ref4[2], _ = _ref4[3], _ = _ref4[4];
          ...
          for (_j = 0, _len2 = group.length; _j < _len2; _j++) {
            _ref4 = group[_j], tag = _ref4[0], i1 = _ref4[1], i2 = _ref4[2], _ = _ref4[3], _ = _ref4[4];
            if (tag !== 'insert') {
              _ref5 = a.slice(i1, i2);
              for (_k = 0, _len3 = _ref5.length; _k < _len3; _k++) {
                line = _ref5[_k];
        ...
        if (((function() {
          ...
          for (_l = 0, _len4 = group.length; _l < _len4; _l++) {
            _ref6 = group[_l], tag = _ref6[0], _ = _ref6[1], _ = _ref6[2], _ = _ref6[3], _ = _ref6[4];
          ...
          for (_l = 0, _len4 = group.length; _l < _len4; _l++) {
            _ref6 = group[_l], tag = _ref6[0], _ = _ref6[1], _ = _ref6[2], j1 = _ref6[3], j2 = _ref6[4];
            if (tag !== 'delete') {
              _ref7 = b.slice(j1, j2);
              for (_m = 0, _len5 = _ref7.length; _m < _len5; _m++) {
                line = _ref7[_m];
